...
public:
    ...
    // StringInArray
    static bool StringInArray(string str, string arr[], int size)
    {
    ...
    // funcion para saber la cantidad de string iguales en un array
    static int StringsInArray(string str, string arr[], int size)
    {
        int count = 0;
        for (size_t i = 0; i < size; i++)
        {
    ...
    static int StringsInArray_Vector(string str, vector<string> arr)
    {
        int count = 0;
